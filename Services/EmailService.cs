                ...
                <table align='center' border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px; background-color: #F7F7F7; margin: 20px auto; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);'>
                  <tr>
                    <td style='padding: 20px 30px 10px 30px; text-align: left;'>
                      <img src='https://onatrix-win24.azurewebsites.net/LogoBrand.svg' alt='Onatrix Company Logo' style='max-width: 200px; height: auto; display: block; margin: 0 auto;'/>
                    </td>
                  </tr>
                    <tr>
                  ...
                  <tr>
                    <td style='padding: 20px; background-color: #4F5955; text-align: center; color: #F2EDDC; font-size: 12px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;'>
